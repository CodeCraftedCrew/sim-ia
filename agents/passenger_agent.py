...
class PassengerAgent(Agent):
    ...
    def walk_to_stop(self, environment_info: PassengerEnvironment):
        ...
        return Event(environment_info.time + time_spent, EventType.AT_STOP, self)
    ...
    def search_alternative(self, environment_info):
        ...
        self.walk_to_stop(environment_info)
